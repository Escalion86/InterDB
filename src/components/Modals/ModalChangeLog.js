...
const data = [
  {
    ...
    date: '--.11.2020',
    updated: [
      'В графике "Чистая прибыль по месяцам" теперь отображаются кружком месяца с незавершенными событиями',
    ],
  },
  {
    version: '0.5.0',
    date: '22.11.2020',
    added: [
      'Добавлена "Аналитика" (доступна только при авторизации тестировщика)',
      'Добавлен фильтр по месяцам в списке транзакций',
      'При создании события теперь можно редактировать или удалить выбранную услугу или клиента (свайп влево-вправо по карточке)',
      'На экранах информации карточки (всех видов), если есть списки связанных карточек, в случае если их много, для их просмотра необходимо нажать соответствующую кнопку и откроется модальное окно со списком',
      'Эффект прозрачности при клике по карточкам и кнопкам (более понятное и приятное взаимодействие с интерфейсом)',
      'Добавлено поле "Комментарий" для данных клиентов',
    ],
    updated: [
      'Оптимизация загрузки списка карточек',
      'При удалении события также можно удалить связанные с ним транзакции',
      'Защита БД от ошибок введенных данных',
      'Отображение и внесение данных о времени (в событиях и услугах)',
    ],
    fixed: [
      'Теперь в числовые поля нельзя написать прочие символы (защита от ошибки пользователя)',
  ...
  },
  {
    ...
    fixed: [
      ...
      'Цвет иконки финансового статуса в карточке события иногда был некорректным',
      'Мелкие исправления и улучшения',
    ],
  },
  {
    ...
    date: '15.11.2020',
    added: [
      'Добавлено меню сортировки для Услуг, Клиентов и Транзакций',
      'При клике по уведомлению открывается соответствующая страница события или клиента',
      'Добавлено поле "Город" для данных клиентов',
    ],
    updated: [
